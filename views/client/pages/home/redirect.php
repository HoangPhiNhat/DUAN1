...
<html lang="en">
    <!--begin::Head-->
    <head>
        <title>404 - AloSMM.Com - Social Media Marketing</title>
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://alosmm.com" />
        <link rel="shortcut icon" href="/assets/media/favicon.ico?1689968051" />
        ...
        <link
            href="/var/www/alosmm.com/public_html/assets/plugins/global/plugins.bundle.css"
            rel="stylesheet" type="text/css" />
        <link href="/var/www/alosmm.com/public_html/assets/css/style.bundle.css"
            rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body"
        ...
        <div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <div class="box_wrong">
                ...
                <section style="margin-top: 30px;" class="error-container">

                </section>
                <h1>Thanh toán thành công! <br></h1>
                <p style="text-align:center"> Chân thành cảm ơn sự tin tưởng của bạn! Hành trình nghỉ ngơi tuyệt vời sắp bắt đầu, chúng tôi rất vui mừng được phục vụ bạn trong hành trình này.</p>
                <p style="text-align:center">Tự động điều hướng về trang chủ sau <span id="countdown">10</span>s.</p>
                <div class="link-container">
                    <a href="http://localhost/DUAN1/index.php?controller=client&action=home" class="more-link">Trở lại trang chủ</a>
                </div>
            </div>
            <style>
			...
			body {
				...
				.box_wrong{position: absolute;left: 50%;transform: translate(-50%,0);z-index: 99;}
				.error-container {
				text-align: center;
				font-size: 106px;
        ...
        <!-- Google tag (gtag.js) -->
        <script async
            src="https://www.googletagmanager.com/gtag/js?id=G-26DRVP52XW"></script>
        <script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'G-26DRVP52XW');
		</script>
        <!--end::Javascript-->
        <script type="text/javascript"
            src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r99/three.min.js"></script>
        <script type="text/javascript" src="/assets/404.js"></script>
        <script type="text/javascript"
