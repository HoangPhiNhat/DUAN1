...
<<<<<<< HEAD
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="customer_id" name="customer_id" placeholder="Nhập Tên người đặt" value="<?php echo login::getNameById($value->customer_id); ?>" readonly>
                </div>

                <div class="form-group">
                    <label for="room_id">Tên phòng</label>
                    <input type="text" class="form-control" id="room_id" name="room_id" placeholder="Nhập Tên phòng" value="<?php echo Rooms::getNameById($value->room_id); ?>" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div>
                    <input type="radio" id="confirmedStatus" name="status" value="Chờ Xác Nhận" <?php echo ($value->status == 'Chờ Xác Nhận') ? 'checked' : ''; ?>>
<label for="confirmedStatus">Chờ Xác Nhận</label>


<input type="radio" id="confirmedStatus2" name="status" value="Đã Xác Nhận">
<label for="confirmedStatus2">Đã Xác Nhận</label>

<input type="radio" id="preparingStatus" name="status" value="Phòng Đang được chuẩn bị">
...
=======
                ...
                <div class="form-group">
                    ...
                    <div>
                        <label>Trạng thái</label>
                        <div>
                            <input type="radio" id="confirmedStatus" name="status" value="Chờ Xác Nhận">
                            <label for="confirmedStatus">Chờ Xác Nhận</label>
                            <input type="radio" id="confirmedStatus" name="status" value="Đã Xác Nhận">
